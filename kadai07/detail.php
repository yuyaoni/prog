...
<form method="post" action="update.php">
    <div class="input">
        <fieldset class="input">
            ...
            <label>体重：<input type="text" name="weight" value="<?=$row["weight"]?>"> kg</label><br>
            <label>距離：<input type="text" name="kyori" value="<?=$row["kyori"]?>"> km</label><br>
            <label>食事：</br><textArea name="syokuji" rows="4" cols="40"><?=$row["syokuji"]?></textArea></label><br>
